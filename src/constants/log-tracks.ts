...
export const CURVE_DEFAULTS: Record<string, CurveDefaults> = {
  ...
  DHAT: {
    ...
    color: '#ef4444',
    unit: 'degC',
    description: 'Downhole Annular Temp',
    gridLines: 4,
  },
  TFLO: {
    scaleMin: 0,
  ...
  DHAP: {
    ...
    color: '#84cc16',
    unit: 'bar',
    description: 'Downhole Annular Pressure',
    gridLines: 5,
  },
  SWOB: {
    scaleMin: -50,
